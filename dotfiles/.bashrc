...
# camos sender service logs
select-pane -t 0
send-keys "camos_sender" C-m

# camos apps information
select-pane -t 1
send-keys "camos_app" C-m

# camos subscriber logs
select-pane -t 2
send-keys "camos_subscriber" C-m
EOF
fi
